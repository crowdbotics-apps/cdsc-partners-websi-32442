...
## Project Structure
    ...
    ├── cdsc_partners_websi_32442  # Django project configurations
...
1. Clone this repo and `cd cdsc_partners_websi_32442`
...
2. Clone this repo and `cd cdsc_partners_websi_32442`
